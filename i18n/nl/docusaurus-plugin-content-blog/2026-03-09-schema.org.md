...
Deze post adviseerde oorspronkelijk `http://schema.org/` (HTTP) op basis van de hieronder beschreven redenen. Dat leidde tot precies de discussie die we hoopten: een gestructureerd gesprek met betrokkenen van NDE, CLARIAH, ODISSEI en erfgoedinstellingen. Op 2 april 2026 bereikten de deelnemers consensus over `https://schema.org/` (HTTPS). Deze post is bijgewerkt om dat besluit te weerspiegelen – zie [de aanbeveling](./2026-03-09-schema.org.md#de-aanbeveling).
:::
