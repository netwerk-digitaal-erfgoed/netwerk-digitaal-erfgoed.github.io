...
### What about a custom context?

JSON-LD 1.1’s [`@import`](https://www.w3.org/TR/json-ld11/#imported-contexts) makes it possible to create a custom context that remaps everything to `https://schema.org/`:
