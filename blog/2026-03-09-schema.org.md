...
Tools – including structured-data validators, knowledge-graph pipelines, and libraries like Riot – normalize everything to `http://` IRIs. They aren’t downgrading security; they’re following the vocabulary definition from the official context. As of Schema.org v29.4, this is still the case.
...
- [**ro-crate#427**](https://github.com/ResearchObject/ro-crate/issues/427) and [**codemeta#373**](https://github.com/codemeta/codemeta/issues/373): both RO-Crate and CodeMeta are discussing moving to HTTPS but still use `http://` in their contexts.
...
- [**PiCo**](https://personsincontext.org/model/) and other NDE community vocabularies have already adopted HTTPS in practice.
