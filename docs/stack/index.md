...
|---------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| [RDF](../glossary.md#rdf) triplestore / SPARQL engine | [QLever](https://github.com/ad-freiburg/qlever) – read-only-after-load, fast bulk-load, fits [blue/green rebuild](patterns.md#bluegreen-rebuild)                      | [Oxigraph](https://github.com/oxigraph/oxigraph), GraphDB, Jena Fuseki                             |
