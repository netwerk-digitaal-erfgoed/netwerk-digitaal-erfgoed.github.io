...
**Audience**: primarily builders of [Service Platforms](../glossary.md#service-platform) and [network services](../services/index.md) within the NDE network. [Data Providers](../glossary.md#data-provider) are a secondary audience: the [Publication Layer](layers/provider.md#publication-layer) is in scope, but what they publish is specified in [Requirements](../requirements/index.md) rather than here.
...
| **NDE-compatible product** | Third-party software that fills a layer by being [NDE-compatible](../glossary.md#nde-compatible): part of the ecosystem, provided by its vendor rather than the Stack, its requirements specified in [Requirements](../requirements/index.md) rather than here | Omeka-S, collection management systems, annotation stores |
