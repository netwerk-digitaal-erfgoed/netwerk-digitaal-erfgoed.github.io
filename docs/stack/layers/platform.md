...
| 5    | Enrich *(inwinnen van verrijkingen)* | –                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | [NDE Network of Terms](../../services/network-of-terms)                                                                 | `@ndes/pipeline-tn-enrich` (calls NoT); NDE “Knowledge Graph voor Termen” network service (term ↔ term, [report function 5](#function-mapping), substrate C); **Term Backlink Graph** (term ↔ record, derived from substrate B)                                                                                                          |
