...
| 4b   | Transformation (semantic) *(transformatie naar een geharmoniseerd model)* | –                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | [SCHEMA-AP-NDE-first](../patterns.md#schema-ap-nde-first) | domain-profile adapters (Linked Art / CIDOC-CRM, RiC-O, RDA, EDM)                                                                                                                                                                                                             |
