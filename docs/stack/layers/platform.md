...
| 3    | Normalisation *(normalisatie van gegevens)* | No dedicated package – realised elsewhere: literal normalisation (dates, names, capitalisation) in [Transformation](../patterns.md#sparql-native-transformation) via CONSTRUCT and [adapters](../patterns.md#adapters); search-time folding/stemming is [engine-dependent](#normalization-is-engine-dependent) | –                                                                                                                       | Wrapper services for AI-tooling at network level (HTR / ATR / ASR / NER)                                                                                                                                                                                                                                        |
