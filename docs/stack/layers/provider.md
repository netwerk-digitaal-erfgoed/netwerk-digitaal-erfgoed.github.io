...
What a [collection management system](../../glossary.md#collection-management-system) must do to be [NDE-compatible](../../glossary.md#nde-compatible) is specified in [Requirements](../../requirements/index.md), not here.
